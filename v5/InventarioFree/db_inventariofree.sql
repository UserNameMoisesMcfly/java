...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-09-2023 a las 19:13:41
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `NUEVO_PRODUCTO` (`CODIGO` VARCHAR(100))   INSERT INTO inventario (inv_pro_codigo) VALUES (CODIGO)$$
...
INSERT INTO `artículos` (`pro_codigo`, `pro_descripcion`, `nomproveedor`, `categoria`, `ubicacion`) VALUES
('022000159342', 'Cerveza de almacen', 'Sol', '40 onzas', 'Nota prueba');
...
INSERT INTO `categorias` (`id`, `nomcategoria`) VALUES
(12, '40 onzas'),
(13, '20 cuartos');
...
INSERT INTO `tareas` (`idTarea`, `numeroSerie`, `nombre`, `herramienta`, `estadoTarea`) VALUES
(1, '0012', 'Axel', 'RJ-45', 'Pendiente'),
(6, '0089', 'Juan', 'Teclado', 'Hecho'),
(7, '0923', '0923', 'tarea de prueba', 'Hecho'),
(8, 'SN', 'Moises', 'Pinzas para Ponchar', 'Pendiente'),
(9, 'ww1', 'Julio', 'Cable RJ45 1m', 'Hecho');
...
(34, '2023-05-21 06:00:00', 'migue', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Supervisor'),
(35, '2023-05-21 06:00:00', 'moi', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Auxiliar'),
(36, '2023-09-29 06:00:00', 'root', 'a665a45920422f9d417e4867efdc4fb8a04a1f3fff1fa07e998e86f7f7a27ae3', 'Administrador');
...
--
ALTER TABLE `entrada`
  MODIFY `ent_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `salida`
  MODIFY `sal_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
